...
List<Destination> destinations = [
  Destination(
    ...
    city: 'New Dehli',
    country: 'India',
    description: 'Visit New Dehli for an amazing and unforgetable adventure',
    activities: activities,
  ),
    Destination(
   ...
   Destination(
    ...
    city: 'São Paulo',
    country: 'Brazil',
    description: 'Visit São Paulo for an amazing and unforgetable adventure',
    activities: activities,
  ),
   Destination(
    ...
    city: 'New York City',
    country: 'USA',
    description: 'Visit NYC for an amazing and unforgetable adventure',
    activities: activities,
  ),
];